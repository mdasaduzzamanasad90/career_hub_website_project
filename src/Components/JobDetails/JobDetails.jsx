...
import { getdataonlocalstorage } from "../utillites/localstorage";
...
const JobDetails = () => {
  ...
  const notify = () =>{ 
    getdataonlocalstorage(idInt)
    toast.success("Your Apply is Successfull")
  };
    ...
    <div className="md:mx-40 md:my-20 mx-10 my-10">
      ...
      <div className="md:grid md:grid-cols-5 md:gap-5 grid gap-5">
        ...
        <div className="bg-[#9873FF1A] py-6 px-4 md:col-span-2 rounded-xl border shadow-xl">
          <h1 className="text-3xl font-bold text-center uppercase bg-gradient-to-r from-[#7E90FE] to-[#9873FF] bg-clip-text text-transparent">
            Job Details
          </h1>
          <div>
          ...
          <div className="border-y-2 py-5">
            <div className="flex gap-3 mb-1">
              ...
              <h1 className="font-bold text-xl">
                Salary :
                <small className="text-[#00000080]">{salary} (Per Month)</small>
              </h1>
            </div>
          ...
          <button
            onClick={notify}
            className="btn w-full text-white rounded-lg font-bold text-lg bg-gradient-to-r from-[#7E90FE] to-[#9873FF]"
          >
            Apply Now
          </button>
        </div>
